...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
                <a class="nav-link link" href="enconstruccion.php">Venta</a>
            </li>
            <li class="nav-item">
                <a class="nav-link link" href="enconstruccion.php">Amenidades</a>
            </li>
        </ul>
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link link cont" href="enconstruccion.php">Contactanos</a>
            </li>
        </ul>
    </div>
</nav>
